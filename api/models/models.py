...
class Hubs2025(Base):
    ...
    google_total_available_length = Column(Float, nullable=True)
    google_total_covered_km = Column(Float, nullable=True)
    ...
    def percent_covered(self):
        return self.google_total_covered_km / self.google_total_covered_km
...
class Roads2025(Base):
    ...
    collected_length = Column(Float, nullable=False, default=0)
    geometry = Column(JSON, nullable = False)
    ...
    def length_diff(self):
        return self.length - self.collected_length
